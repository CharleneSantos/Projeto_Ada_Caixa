...
from funcoes import adicionar_novo_item, medias, mostrar_medias_por_area, valores_unicos, calcular_nota_media, valores_unicos_por_grupo, porcentagem_por_grupos, calcular_estatisticas, st_porcentagem_por_grupos, salvar_dic_em_csv, grafico_porcentagem
